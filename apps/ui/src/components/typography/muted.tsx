...
export interface MutedProps
  extends React.HTMLAttributes<HTMLParagraphElement>, VariantProps<typeof mutedVariants> {}

const Muted = React.forwardRef<HTMLParagraphElement, MutedProps>(
  ({ className, variant, ...props }, ref) => {
    return <p ref={ref} className={cn(mutedVariants({ variant, className }))} {...props} />
  }
)
